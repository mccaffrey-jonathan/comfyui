...
Definitions: "Covered provider" = producer of a GenAI system with > 1,000,000 monthly visitors/users, publicly accessible in California; "Latent" = present but not manifest; "Manifest" = easily perceived by a natural person; §22757.3(a) also requires offering an optional *manifest* (visible) disclosure. **AB 853 (signed 13 Oct 2025)** moved the operative date from 1 Jan 2026 to **2 Aug 2026**, extends duties to large online platforms (2027) and capture-device makers (2028). **Correction (17 Sep 2026, from the independent California review):** the chaptered AB 853 (Ch. 674, Stats. 2025) amends §§22757.1, 22757.4, 22757.6 and adds §§22757.3.1-.3.3; it does **not** add an item "(E) whether the content is generated or modified by AI" to §22757.3(b). That created-vs-altered element, the "disclosure verification tool" and the removal of the 1 M-user threshold are **pending SB 1000** changes (presented to the Governor 2 Sep 2026, deadline 30 Sep 2026), not current law. An earlier draft of this report attributed them to AB 853 ([mirror consulted](https://github.com/aaronjuar-ez/PUBINFO-2025); summaries: [Hintze Law](https://hintzelaw.com/blog/2025/10/19/california-amends-artificial-intelligence-transparency-act-and-passes-ai-defenses-act), [CASRAI](https://casrai.org/news/california-sb-942-ai-transparency-act-effective-august-2026) (snippets)). Penalty: $5,000 per violation per day (snippet).
...
| created-vs-altered flag (pending SB 1000, not current law) | `c2pa.created` vs `c2pa.edited`; `digitalSourceType: trainedAlgorithmicMedia` (or `compositeWith...`) |
