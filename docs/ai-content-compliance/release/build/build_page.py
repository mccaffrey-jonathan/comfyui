    ...
    <div>
      <div class="tablewrap"><table>
        ...
        <tbody>
          ...
          <tr><td>Corpus run: ring guard stopped the scale search at 2x upscale (advertised 2.5x)</td><td class="yes">fixed: scale-aware guard, 0.4 to 3x default search, regression test</td></tr>
