...
<section id="watermark">
  ...
  <div class="two">
    <div class="prose">
      ...
      <p class="small">No model weights, no GPU: pure numpy and scipy. About 0.8 s to embed and 2 s to detect a 768 px image on one CPU core. MIT licensed. Also usable from the command line and as a two-function Python library for detection services.</p>
    </div>
    <div>
      <div class="three">
...
<section id="compliance">
  <div class="eyebrow">Regulatory mapping · not legal advice</div>
...
<footer>All images on this page were produced by executing the released nodes inside ComfyUI (CPU) on the bundled example image; no diffusion model was run. Numbers are from the packs' benchmark and quality-sweep scripts on 13 September 2026. Demo certificate: self-issued "Acme Image Studio" test chain.</footer>
</div>
